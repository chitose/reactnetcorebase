...
declare namespace I18next {
  ...
  class I18n {
    ...
    getResourceBundle(lng: string, ns: string): ResourceStoreKey;

    addResourceBundle(lng: string, ns: string, resources: ResourceStoreKey, deep?: boolean, overrite?: boolean): void;
  }
}
